...
public class BigDecimalUtil {
    ...
    public static int round(String price, int i) {
        BigDecimal bigDecimal = new BigDecimal(price);
        return getIntegerPrice(bigDecimal.setScale(i, RoundingMode.HALF_UP));
    }
    ...
    public static BigDecimal add(BigDecimal num1, BigDecimal num2) {
        return add(num1, num2, BigDecimalUtil.PRICE_DECIMAL_POINT);
    }
     ...
     * @return
     */
    public static BigDecimal multiply(BigDecimal num1, int num2, int point) {
        return setScale(num1.multiply(new BigDecimal(num2)), point);
    }
    public static BigDecimal multiply(BigDecimal num1, int num2) {
        return setScale(num1.multiply(new BigDecimal(num2)), PRICE_DECIMAL_POINT);
    }
    ...
    public static BigDecimal divide(BigDecimal num1, BigDecimal num2) {
        return divide(num1, num2, BigDecimalUtil.PRICE_DECIMAL_POINT);
    }
    public static BigDecimal divide(BigDecimal num1, int num2) {
        return divide(num1, BigDecimal.valueOf(num2));
    }
    /**
     * 设置小数点类型为 四舍五入
     *
     ...
     * @return
     */
    public static String convertToPercent(BigDecimal num) {
    ...
    public static BigDecimal convertToPoint(String percent) {
        percent = percent.replace("%", "");
        BigDecimal d = divide(new BigDecimal(percent), new BigDecimal(100), 2);
        return d;
    ...
    public static int getIntegerPrice(BigDecimal price) {
        if (price == null) {
            return 0;
        }
        return price.multiply(new BigDecimal(100)).intValue();
    }
    public static BigDecimal getFenPrice(BigDecimal price) {
        return BigDecimalUtil.multiply(price, 100);
    }
